...
public class ManagerServiceTests {
    ...
    public void testCreateRequestResources() {
        ...
        when(requestResourceRepository.save(any(com.springboot.emp_mang.entities.RequestResource.class))).thenReturn(new com.springboot.emp_mang.entities.RequestResource());

        List<com.springboot.emp_mang.entities.RequestResource> resources = managerService.createRequestResources(request);
        ...
        verify(requestResourceRepository, times(2)).save(any(com.springboot.emp_mang.entities.RequestResource.class));
    }
}
