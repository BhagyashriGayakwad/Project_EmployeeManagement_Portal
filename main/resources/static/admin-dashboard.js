document.addEventListener('DOMContentLoaded', () => {
    ...
    // ADD USER
    const createUserButton = document.getElementById('createuserslink');
    if (createuserslink && addUserModal && addUserForm) {
        createuserslink.addEventListener('click', () => {
 ...
 // ADD PROJECT
    ...
    if (addProjectLink && addProjectModal && addProjectForm) {
        addProjectLink.addEventListener('click', async () => {
    ...
    // ASSIGN PROJECT
    const assignprojectLink = document.getElementById('assignprojectLink');

    if (assignprojectLink && assignProjectModal && assignProjectForm) {
        assignprojectLink.addEventListener('click', async () => {
            try {
