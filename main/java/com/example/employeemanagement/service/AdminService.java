...
public class AdminService {
    ...
    public void assignProject(Long projectId, Long employeeId) {
        List<com.emp.entities.ProjectAssign> existingAssignments = assignmentRepository.findByEmployeeUserId(employeeId);
        ...
        com.emp.entities.ProjectAssign assignment = new com.emp.entities.ProjectAssign();
    ...
    public void unassignProject(Long projectId, Long employeeId) {
        com.emp.entities.ProjectAssign assignment = assignmentRepository.findByProjectProjectIdAndEmployeeUserId(projectId, employeeId)
